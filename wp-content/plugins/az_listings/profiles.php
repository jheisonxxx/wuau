...
function azlp_init() {
    register_post_type('azl_profile', apply_filters('azl_register_post_type_profile', array(
        'labels' => array(
            ...
            'add_new' => _x('Add Profile', 'azl'),
            'add_new_item' => _x('Add New Profile', 'azl'),
            'edit_item' => _x('Edit Profile', 'azl'),
            'new_item' => _x('New Profile', 'azl'),
            'view_item' => _x('View Profile', 'azl'),
            'search_items' => _x('Search Profiles', 'azl'),
            'not_found' => _x('No Profile found', 'azl'),
            'not_found_in_trash' => _x('No Profile found in Trash', 'azl'),
            'parent_item_colon' => _x('Parent Profile:', 'azl'),
            'menu_name' => _x('Profiles', 'azl'),
        ),
