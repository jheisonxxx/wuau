    ...
    function create_elements_dialog(callback) {
        function filters_change() {
            ...
            if (category == '' && tag == '') {
                ...
                if (category == '' && tag != '') {
                    $('.azh-elements-form .azh-elements-filters ~ .azh-element').css('display', 'none');
                    $('.azh-elements-form .azh-elements-filters ~ .azh-element.' + tag).css('display', 'inline-block');
                }
                if (category != '' && tag != '') {
                    $('.azh-elements-form .azh-elements-filters ~ .azh-element').css('display', 'inline-block');
                    $('.azh-elements-form .azh-elements-filters ~ .azh-element:not([data-path^="' + category + '"])').css('display', 'none');
                    $('.azh-elements-form .azh-elements-filters ~ .azh-element:not(.' + tag + ')').css('display', 'none');
                }
            }
        }
        $.ui.dialog.prototype._focusTabbable = $.noop;
        var form = $('<div class="azh-elements-form" title="Shortcodes and Elements"></div>');
        ...
        $(azh.options.inline_wrapper_patterns).each(function() {
            ...
            while ((match = inline_wrapper_pattern.exec(code_line)) != null && match.length == 1) {
                if (!('matched' in data.node)) {
                    ...
                    $(data.node.wrapper).on('contextmenu', function() {
                        return false;
                    });
                    ...
                    if ($(this).is('.azh-empty')) {
                        ...
                        $($(wrapper).parents('.azh-element-wrapper')).each(function() {
                            ...
                            if (element.length && element.data('child-suggestions')) {
                                azh.child_suggestions = azh.child_suggestions.concat(element.data('child-suggestions'));
                            }
                        });
                        create_elements_dialog(function(path, element) {
