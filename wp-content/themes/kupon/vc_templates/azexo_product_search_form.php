    ...
    <div class="searchform-wrapper">
        <div class="product-cat-wrapper">
            <select name="product_cat">
                <option value=""><?php print esc_html__('Select your category', 'AZEXO') ?></option>
                <?php
        ...
        <div class="s-wrapper">
            <input type="text" name="s" value="<?php print get_search_query(); ?>" placeholder="<?php print esc_attr__('Enter keywords here', 'AZEXO'); ?>" />
        </div>
        <div class="submit">
            <input type="submit" value="<?php print esc_attr__('Search products', 'AZEXO'); ?>">
        </div>
